        ...
        <div className='my-16   flex justify-center items-center  '>
            <div className='w-96  shadow-2xl p-7' >
                ...
                <form onSubmit={handleSubmit(handleSignup)}>
                    ...
                    <div className="form-control w-full my-5">
                        <label className="label"><span className="label-text">Addres</span></label>
                        <input {...register("address", { required: 'Address is required' })}
                            type="text" placeholder="Address" className="input input-bordered w-full " />
                        {errors.name && <p role='alert' className='text-red-500'>Address is required</p>}
                    </div>
                    <div className="form-control w-full my-5">
                    ...
                    <div className="form-control">
                        <p>Please click on checkbox if you want to register as a Transporter.</p>
                        <label className="cursor-pointer label">
                            <span className="label-text text-xl font-semibold">Transporter?</span>
